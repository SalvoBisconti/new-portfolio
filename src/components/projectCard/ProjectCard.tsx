...
const ProjectCard = (props: { data: projectsType }) => {
  ...
  return (
    <div className="relative flex flex-col  items-center justify-center gap-2  w-[110vw] rounded-xl p-4 bg-first md:flex-row md:w-[800px] xl:w-[68vw] overflow-hidden  ">
